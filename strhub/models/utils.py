...
def _get_model_class(key):
    if 'abinet' in key:
    ...
    elif 'parseq_iter' in key:
        from .parseqv2.system import IterPARSeq as ModelClass
    elif 'parseq' in key:
        ...
        from .abinet.system import IterVM as ModelClass
    elif 'iternet' in key:
        from .abinet.system import IterNet as ModelClass
    else:
